...
class SegmentEditorAmnioML(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = "SegmentEditorAmnioML"
        self.parent.categories = ["Segmentation"]
        self.parent.dependencies = ["Segmentations"]
        self.parent.contributors = ["Centro Pi"]
...
class SegmentEditorAmnioMLTest(ScriptedLoadableModuleTest):
    """
    ...
    def test_AmnioML1(self):
        ...
        The test can be executed from SelfTests module (test name: SegmentEditorAmnioML)
        """

        self.delayDisplay("Starting test_AmnioML1")
        ...
        segmentEditorWidget.setActiveEffectByName("AmnioML")
        ...
        self.delayDisplay('test_AmnioML1 passed')
