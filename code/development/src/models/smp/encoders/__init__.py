...
def get_encoder_names() -> List:
    return list(encoders.keys())


def get_preprocessing_params(encoder_name: str, pretrained: str = "imagenet") -> Dict:
...
def get_preprocessing_fn(encoder_name: str, pretrained: str = "imagenet") -> Callable:
