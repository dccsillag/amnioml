...
class Model(SegmentationModel):
    ...
    Args:
        ...
        decoder_attention_type: Attention module used in decoder of the model. Available options are **None** and
        **scse**. SCSE paper - https://arxiv.org/abs/1808.08127
    ...
    def __init__(
        ...
        **kwargs: Dict,
        ...
        self.name = "unetplusplus-{}".format(encoder)
        self.initialize()
